                      ...
                      <>
                        ...
                        {!isStraights && (() => {
                          ...
                          const bookRow = (r, faded, best) => (
                            <a key={r.book} href={placeLink(r.book) || '#'} target="_blank" rel="noopener noreferrer" onClick={() => placeOn(r.book, enabled.map(l => l.pick).join(' + '), null)} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '13px', marginTop: '7px', borderRadius: '11px', border: `1px solid ${best ? NEON : 'var(--border)'}`, background: best ? 'rgba(189,255,0,0.08)' : 'transparent', textDecoration: 'none', opacity: faded ? 0.45 : 1 }}>
