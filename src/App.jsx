  ...
  return (<>
    ...
    <div style={isLadder
      ...
      {!isLadder ? (<>
        ...
        {/* max-height pull-down — animates reliably on iOS Safari (grid-rows did not) */}
        <div style={{ maxHeight: actionsOpen ? '64px' : '0', overflow: 'hidden', transition: 'max-height 0.26s ease' }}>
          {isOpen ? (
            <div style={{ display: 'flex', borderTop: '1px solid var(--border)' }}>
              {[
                { r: 'W', label: 'WIN ✓',  color: NEON_T, bg: 'rgba(189,255,0,0.07)' },
...
<body>
  ...
  return (
    <div data-theme={darkMode ? 'dark' : 'light'} style={{ backgroundColor: 'var(--bg)', minHeight: '100vh', fontFamily: R, overflowX: 'hidden', maxWidth: isMobile ? '100vw' : '480px', margin: isMobile ? '0' : '0 auto', boxShadow: isMobile ? 'none' : '0 0 0 1px rgba(255,255,255,0.04), 0 32px 80px rgba(0,0,0,0.5)' }}>
